...
const ServicesCardSecondRow = ({
  ...
  return (
    <div className={`flex flex-col-reverse mt-32 xl:mt-0 xl:flex-row mx-auto mb-10 xl:w-[1137px] items-center  justify-between`}>
      <div className="mt-6 lg:mt-0 xl:w-[493px] ">
        ...
        <div className="xl:w-[494px] flex flex-col xl:h-[692px] rounded-[24px] ">
          <Image
            src={img}
          alt="services"
          />
